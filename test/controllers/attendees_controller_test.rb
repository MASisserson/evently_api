...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference("Attendee.count") do
      post attendees_url, params: { attendee: { event_id: @attendee.event_id, form: @attendee.form } }, as: :json
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { event_id: @attendee.event_id, form: @attendee.form } }, as: :json
    assert_response :success
  end
